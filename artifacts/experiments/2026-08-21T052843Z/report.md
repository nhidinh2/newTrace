...
| --- | --- | --- | --- | --- | --- | --- | --- |
| full | 384 | 0.1978 | 1536.0 | 0.0503 | 0.0615 | 0.0000 | 0.0002 |
| svd | 32 | 0.0165 | 128.0000 | 0.0270 | 0.0289 | 0.0020 | 0.0001 |
| svd | 64 | 0.0330 | 256.0000 | 0.0307 | 0.0333 | 0.0022 | 0.0001 |
| svd | 80 | 0.0412 | 320.0000 | 0.0309 | 0.0325 | 0.0026 | 0.0001 |
| gaussian_rp | 32 | 0.0165 | 128.0000 | 0.0275 | 0.0312 | 0.0003 | 0.0001 |
| gaussian_rp | 64 | 0.0330 | 256.0000 | 0.0310 | 0.0325 | 0.0004 | 0.0001 |
| gaussian_rp | 128 | 0.0659 | 512.0000 | 0.0338 | 0.0479 | 0.0007 | 0.0002 |
| gaussian_rp | 256 | 0.1318 | 1024.0 | 0.0400 | 0.0675 | 0.0012 | 0.0001 |
| sparse_rp | 32 | 0.0165 | 128.0000 | 0.0283 | 0.0375 | 0.0005 | 0.0001 |
| sparse_rp | 64 | 0.0330 | 256.0000 | 0.0307 | 0.0320 | 0.0006 | 0.0002 |
| sparse_rp | 128 | 0.0659 | 512.0000 | 0.0332 | 0.0348 | 0.0009 | 0.0002 |
| sparse_rp | 256 | 0.1318 | 1024.0 | 0.0397 | 0.0482 | 0.0014 | 0.0002 |
...
- `svd` at d=32: retained **94.8%** of baseline nDCG@10 with a 12.00× smaller index; p95 query latency 2.13× the baseline's (>1 = faster than full).
- `svd` at d=64: retained **98.8%** of baseline nDCG@10 with a 6.00× smaller index; p95 query latency 1.85× the baseline's (>1 = faster than full).
- `svd` at d=80: retained **98.9%** of baseline nDCG@10 with a 4.80× smaller index; p95 query latency 1.89× the baseline's (>1 = faster than full).
- `gaussian_rp` at d=32: retained **94.5%** of baseline nDCG@10 with a 12.00× smaller index; p95 query latency 1.97× the baseline's (>1 = faster than full).
- `gaussian_rp` at d=64: retained **94.9%** of baseline nDCG@10 with a 6.00× smaller index; p95 query latency 1.89× the baseline's (>1 = faster than full).
- `gaussian_rp` at d=128: retained **100.6%** of baseline nDCG@10 with a 3.00× smaller index; p95 query latency 1.28× the baseline's (>1 = faster than full).
- `gaussian_rp` at d=256: retained **100.0%** of baseline nDCG@10 with a 1.50× smaller index; p95 query latency 0.91× the baseline's (>1 = faster than full).
- `sparse_rp` at d=32: retained **73.2%** of baseline nDCG@10 with a 12.00× smaller index; p95 query latency 1.64× the baseline's (>1 = faster than full).
- `sparse_rp` at d=64: retained **97.6%** of baseline nDCG@10 with a 6.00× smaller index; p95 query latency 1.92× the baseline's (>1 = faster than full).
- `sparse_rp` at d=128: retained **99.3%** of baseline nDCG@10 with a 3.00× smaller index; p95 query latency 1.77× the baseline's (>1 = faster than full).
- `sparse_rp` at d=256: retained **100.7%** of baseline nDCG@10 with a 1.50× smaller index; p95 query latency 1.28× the baseline's (>1 = faster than full).
...
Per-query results are in `per_query_metrics.parquet` (or `.csv`). The tables above
report means over 27 queries without confidence
intervals; with a query set this small, differences of a few points should not be
treated as significant. Bootstrap intervals over the per-query file are the right
next step.
